  ...
  <div class="container mx-auto p-4 sm:p-6">
    <section v-if="selectedPlace" class="grid gap-6 lg:grid-cols-2">
      ...
      <base-card class="bg-white shadow-lg rounded-2xl p-6">
        <div>
          <img :src="selectedPlace.image || 'https://via.placeholder.com/300'" alt="Place Image"
        ...
        <header class="text-center">
          ...
          <base-card class="bg-white shadow-lg rounded-2xl p-6">
            <div class="flex flex-wrap gap-2 mb-4">
              <base-badge v-for="service in selectedPlace.services" :key="service" :type="service" :title="service"
                class="bg-pewter-blue text-white px-3 py-1 rounded-lg text-xs sm:text-sm shadow-sm"></base-badge>
            </div>
